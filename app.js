...
export default function DevisForm() {
  ...
  function validate() {
    ...
    else if (fields.nom.trim().length > 50) errs.nom = "50 caractères maximum";
    ...
    else if (fields.email.length > 50) errs.email = "50 caractères maximum";
    ...
    if (fields.desc.length > 1000) errs.desc = "1000 caractères maximum";
  ...
  const inputBase =
    "w-full bg-white/[0.04] border rounded-lg px-3.5 py-3 text-pbm-white font-dm text-sm outline-none transition-all duration-200 placeholder:text-pbm-grey focus:border-pbm-blue3/50 focus:bg-pbm-blue3/[0.06]";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(55,48,212,0.13) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-[660px] text-center">
        ...
        <p className="mt-3 font-dm text-sm font-light leading-relaxed text-pbm-grey2">
          Décrivez votre projet. Nous vous recontactons rapidement pour
          organiser un déplacement gratuit.
        </p>
        ...
        >
          {formspreeState.succeeded ? (
            ...
            <form
              action="https://formspree.io/f/xnjlyryo"
              method="POST"
